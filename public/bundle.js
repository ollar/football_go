...
/***/ function(module, exports, __webpack_require__) {
	...
	var playersTable = new _table2.default();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _translate = __webpack_require__(44);
	...
	var PlayersTable = function (_Backbone$View) {
	  _inherits(PlayersTable, _Backbone$View);
	  ...
	  _createClass(PlayersTable, [{
	    ...
	    key: 'template',
	    get: function get() {
	      return (0, _virtualDom.h)('div.play-team', [(0, _virtualDom.h)('span', _translate2.default.t('Football match process')), (0, _virtualDom.h)('ul.players-list', this.collection.map(function (model) {
	        return new _player2.default({ model: model }).render();
	      })), (0, _virtualDom.h)('form', { onsubmit: this.addPlayer.bind(this) }, [(0, _virtualDom.h)('input', { type: 'text', name: 'name', placeholder: 'foo' }), (0, _virtualDom.h)('button.submit-go', 'submit go')])]);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerView = function (_Backbone$View) {
	  _inherits(PlayerView, _Backbone$View);
	  ...
	  _createClass(PlayerView, [{
	    ...
	    key: 'template',
	    get: function get() {
	      return (0, _virtualDom.h)('li', [(0, _virtualDom.h)('span', this.model.get('name')), (0, _virtualDom.h)('div.remove', { onclick: this.onRemove.bind(this) }, 'remove')]);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ru = __webpack_require__(62);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _i18next = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ResourceStore = __webpack_require__(50);
	
	var _ResourceStore2 = _interopRequireDefault(_ResourceStore);
	
	var _Translator = __webpack_require__(52);
	
	var _Translator2 = _interopRequireDefault(_Translator);
	
	var _LanguageUtils = __webpack_require__(55);
	
	var _LanguageUtils2 = _interopRequireDefault(_LanguageUtils);
	
	var _PluralResolver = __webpack_require__(56);
	
	var _PluralResolver2 = _interopRequireDefault(_PluralResolver);
	
	var _Interpolator = __webpack_require__(57);
	
	var _Interpolator2 = _interopRequireDefault(_Interpolator);
	
	var _BackendConnector = __webpack_require__(58);
	
	var _BackendConnector2 = _interopRequireDefault(_BackendConnector);
	
	var _CacheConnector = __webpack_require__(59);
	
	var _CacheConnector2 = _interopRequireDefault(_CacheConnector);
	
	var _defaults2 = __webpack_require__(60);
	
	var _postProcessor = __webpack_require__(53);
	
	var _postProcessor2 = _interopRequireDefault(_postProcessor);
	
	var _v = __webpack_require__(54);
