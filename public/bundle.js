	...
	var PlayersTable = function (_View) {
	  ...
	  _createClass(PlayersTable, [{
	    ...
	    value: function initialize() {
	      this.nextWed = (0, _moment2.default)().day(10).format('YYYY-MM-DD');
	    ...
	    key: 'template',
	    get: function get() {
	      return (0, _virtualDom.h)('div.play-team', [(0, _virtualDom.h)('h1', [(0, _virtualDom.h)('span', _translate2.default.t('Football match process')), this.collection.matchDate ? (0, _virtualDom.h)('span', (0, _moment2.default)(new Date(this.collection.matchDate)).locale('ru').format('DD MMMM')) : (0, _virtualDom.h)('span', { onclick: this.initMatch.bind(this) }, '+')]), (0, _virtualDom.h)('ol.players-list', this.collection.map(function (model) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TeamCollection = function (_Backbone$Collection) {
	  ...
	  _createClass(TeamCollection, [{
	    ...
	    key: 'matchDate',
	    get: function get() {
	      return (0, _moment2.default)().day(10).format('YYYY-MM-DD');
	    }
	  }, {
	    key: 'model',
	    get: function get() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(45), (function() { return this; }()), __webpack_require__(38)(module)))
